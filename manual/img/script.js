...
id=0;
	...
	$("#pbutton li").eq(0).addClass("but_ac");
	$("#plusImage li").eq(0).addClass("img_ac");

$("#pbutton li").click(function(){
	imgID=$(this).index();

	$("#pbutton li").removeClass("but_ac").eq(imgID).addClass("but_ac");
	$("#plusImage li").removeClass("img_ac").eq(imgID).addClass("img_ac");
})
